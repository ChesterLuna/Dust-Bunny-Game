...
public class DustCloud : MonoBehaviour
{
    ...
    {
        OLDPlayerController _newPlayer = other.gameObject.GetComponent<OLDPlayerController>();
        if (_newPlayer)
        {
            _player = _newPlayer;
    ...
    {
        OLDPlayerController player = other.gameObject.GetComponent<OLDPlayerController>();
        if (player == null)
            return;
        if (player == _player)
        {
