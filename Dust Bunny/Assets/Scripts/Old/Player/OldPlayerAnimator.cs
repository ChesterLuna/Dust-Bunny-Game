...
{
    private OLDPlayerController _player;
    private Animator _anim;
    private Rigidbody2D _rb;

    private void Awake()
    {
        _player = GetComponentInParent<OLDPlayerController>();
    ...
    public void OnPlayerFootstep() // TODO
    {
    ...
    private void HandleAnimations()
    {
        ...
        int GetState()
        {
            ...
            else if (_player.PlayerState == OLDPlayerController.PlayerStates.Dialogue)
            {
                return Idle;
            }
            else if (_dashing)
            ...
            {
                if (UserInputOLD.instance.MoveInput.x == 0f)
                {
                    return Idle;
                }
                else
